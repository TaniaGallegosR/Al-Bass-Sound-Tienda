<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMAESTRA.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="TaniaCinemasStore.Categorias" %>
...
.shop__slideshow .Horizontal-inner .item__container {
  display: table;
  width: 100%;
  height: 100%;
}
.shop__slideshow .Horizontal-inner .item-container__inner {
  display: table-cell;
  vertical-align: middle;
}
.shop__slideshow .Horizontal-inner .item {
  width: 100%;
  height: 600px;
}
.shop__slideshow .Horizontal-inner .item_1 {
  background: url(../img/home_11.jpg) no-repeat center center / cover;
}
.shop__slideshow .Horizontal-inner .item_2 {
  background: url(../img/home_12.jpg) no-repeat center center / cover;
}
.shop__slideshow .Horizontal-inner .item_3 {
  ...
  font-weight: 600;
    ...
    <div class="container">
      <div class="row">
          ...
          <asp:Repeater ID="Repeater1" runat="server" DataSourceID="CatSortSqlDataSource">
              <ItemTemplate>
                  <div class="col-sm-6 col-md-4">
                      <div class="shop__thumb">
                          <a href="Defaul2.aspx?id=<%# Eval("p_id") %>">
                              <div class="shop-thumb__img">
                                  <img src="Imagenes_Productos/<%# Eval("p_imagen") %>" class="img-responsive my " alt="<%# Eval("p_nombre") %>">
                              </div>
                              <h5 class="shop-thumb__title"><%# Eval("p_nombre") %>
                                  <span class="badge pull-right"><%#Eval("p_marca") %> </span>
                              </h5>

                              <div class="shop-thumb__price">
                                 
                                 <i class="fa fa-rupee"></i><span class="shop-thumb-price_new"><%# Eval("p_precio") %></span>
          ...
          <asp:SqlDataSource runat="server" ID="CatSortSqlDataSource" ConnectionString='<%$ ConnectionStrings:TaniaConexion %>' SelectCommand="SELECT * FROM [Producto] WHERE ([cat_id] = @cat_id)">
              <SelectParameters>
                  <asp:QueryStringParameter QueryStringField="id" Name="cat_id" Type="String"></asp:QueryStringParameter>
              </SelectParameters>
          </asp:SqlDataSource>
