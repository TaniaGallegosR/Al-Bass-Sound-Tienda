<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMAESTRA.Master" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="TaniaCinemasStore.Productos" %>
  ...
  font-weight: 600;
    ...
    <div class="container">
      <div class="row">
       ...
       <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:TaniaConexion %>' SelectCommand="SELECT * FROM [Producto]"></asp:SqlDataSource></div>
